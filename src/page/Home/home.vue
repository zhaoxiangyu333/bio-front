  ...
  <div>
    <div class="banner">
      <div class="bg" ref="bg"
        ...
        <span class="text b">Bio前端<br/>by BLZ</span>
        <span class="copyright c">感谢XX提供的前端模板</span>
      </div>
    </div>
    ...
    <section class="w mt30 clearfix" v-for="(item,i) in floors" :key="i">
      <y-shelf :title="item.name">
        <div slot="content" class="floors">
          <div class="imgbanner">
            <img v-lazy="floors[i].img" :alt="item.name">
          </div>
...
<script>
  import {hotProduct, hotBrand} from '../../api/index'
