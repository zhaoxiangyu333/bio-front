        ...
        <div v-if="orderList.length">
          <div v-for="(item,i) in orderList" :key="i">
            <div class="gray-sub-title cart-title">
              <div class="first">
                <div>
                  <span class="date" v-text="item.createdTime"></span>
            ...
            <div class="pr">
              <div class="cart" >
                <div class="cart-l" >
                  ...
                  <div class="cart-l-r">
                    ...
                    <div class="type"><a @click="_delOrder(item.orderId,i)" href="javascript:;" class="del-order">删除此订单</a>
                    </div>
                  </div>
                </div>
                <div class="cart-r">
              ...
              <div class="prod-operation pa" style="right: 0;top: 0;">
                ...
                <div class="status"> {{item.orderStatus === '1' ? '已支付' : '未支付'}}  </div>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      _orderList () {
        orderList({token: getStore('token')}).then(res => {
