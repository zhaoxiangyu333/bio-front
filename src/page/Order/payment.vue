  ...
  <div class="w" style="padding-bottom: 100px;">
    ...
    <div class="p-msg w">
      <div class="confirm-detail">
        ...
        <p class="info-detail">姓名：{{addList.name}}</p>
        <p class="info-detail">联系电话：{{addList.mobile}}</p>
        <p class="info-detail">详细地址：{{addList.remark}}</p></div>
    </div>
...
<script>
  ...
  import { addressById, getCartList, payMent, productDet } from '/api/goods'
